...
export const projects: Project[] = [
  {
    ...
    tags: ['C#', 'ASP.NET Core', 'Python', 'React', 'PostgreSQL', 'HTML/CSS', 'PyTorch', 'FastAPI', 'Node.js', 'Git', 'Supabase'],
  ...
  },
  {
    ...
    tags: ['JavaScript', 'React', 'HTML/CSS', 'Astro', 'Git', 'Tailwind CSS', 'TypeScript', 'Vercel'],
